...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>T.jsxs("p",{children:[" Posted by  ",T.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Lc=({comment:e})=>T.jsxs("div",{className:"CommentInfo",children:[T.jsxs("div",{className:"CommentInfo__title",children:[T.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",T.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),T.jsx("div",{className:"CommentInfo__body",children:e.body})]},e.id),Tc=({comments:e})=>T.jsx(T.Fragment,{children:e.length===0?T.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):T.jsx("div",{className:"CommentList",children:e.map(t=>T.jsx(Lc,{comment:t},t.id))})}),Mc=({post:e})=>T.jsxs("div",{className:"PostInfo",children:[T.jsxs("div",{className:"PostInfo__header",children:[T.jsx("h3",{className:"PostInfo__title",children:e.title}),T.jsx(Pc,{user:e.user})]}),T.jsx("p",{className:"PostInfo__body",children:e.body}),T.jsx("hr",{}),T.jsx(Tc,{comments:e.comments||[]})]},e.id),Rc=({posts:e})=>T.jsx(T.Fragment,{children:e.map(t=>T.jsx(Mc,{post:t}))});function Dc(e){return Nc.find(t=>t.id===e)||null}function jc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>T.jsxs("section",{className:"App",children:[T.jsx("h1",{className:"App__title",children:"Static list of posts"}),T.jsx("div",{className:"PostList",children:T.jsx(Rc,{posts:Oc})})]});em(document.getElementById("root")).render(T.jsx(Fc,{}));
